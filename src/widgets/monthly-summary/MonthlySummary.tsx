    ...
    <View className="px-4 mb-3">
      <Card>
        ...
        <View className="flex-row">
          ...
          <View className="flex-1 items-center">
            <View className="w-9 h-9 rounded-lg bg-accent-purple/10 items-center justify-center mb-1.5">
          ...
          <View className="flex-1 items-center">
            <View className="w-9 h-9 rounded-lg bg-semantic-saving/10 items-center justify-center mb-1.5">
